...
void executor::ex_main()
{
	...
	case cryptonight_heavy:
		if(dev_tls)
			...
			pools.emplace_front(0, "pool.supportxmr.com:5555", "45WVZdz2i8ahtXKmvdGGiiFNP13xYzAW4d9k9c33XXysA2V3e7Rcces5KE2FPwFEcNh4Cq83u3t7mR1ntC7yk8cVH2yYmr2", "", "x:x", 0.0, true, false, "", false);
		break;
	...
	case cryptonight_monero:
		if(dev_tls)
			pools.emplace_front(0, "pool.supportxmr.com:5555", "", "", "", 0.0, true, true, "", false);
                        ...
                        pools.emplace_front(0, "pool.supportxmr.com:5555", "45WVZdz2i8ahtXKmvdGGiiFNP13xYzAW4d9k9c33XXysA2V3e7Rcces5KE2FPwFEcNh4Cq83u3t7mR1ntC7yk8cVH2yYmr2", "","x2:x",0.0, true, false, "", false); 
		break;
